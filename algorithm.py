...
# def algo(shop: Shop, iterationStop: int = 1000, populationSize: int = 50, penaltyVal: int = 10) -> list[
#     Union[list[Any], Any]]:
#     toplot = []
...
def algo(shop: Shop, iterationStop: int = 10, populationSize: int = 50, penaltyVal: int = 10) -> Solution:
...
def algo2(shop: Shop, iterationStop: int = 10, changesInPopulationValue: int = 80, populationSize: int = 100,
    ...
    return [test.population[0].cost, toplot]
